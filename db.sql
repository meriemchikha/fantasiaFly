...
SET destination_description =
CASE
WHEN id = 1 THEN 'Description 1'
WHEN id = 2 THEN 'Description 2'
WHEN id = 3 THEN 'Description 3'
WHEN id = 4 THEN 'Description 4'
WHEN id = 5 THEN 'Description 5'
WHEN id = 6 THEN 'Description 6'
WHEN id = 7 THEN 'Description 7'
WHEN id = 8 THEN 'Description 8'
WHEN id = 9 THEN 'Description 9'
WHEN id = 10 THEN 'Description 10'
WHEN id = 11 THEN 'Description 11'
WHEN id = 12 THEN 'Description 12'
WHEN id = 13 THEN 'Description 13'
